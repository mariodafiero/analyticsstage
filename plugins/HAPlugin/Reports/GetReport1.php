...
namespace Piwik\Plugins\HAPlugin\Reports;
 ...
 */
class GetReport1 extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('HAPlugin_Report1');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('ReportHA Description');
        ...
        // $this->menuTitle    = 'HAPlugin_Report1';
        ...
        // $this->widgetTitle  = 'HAPlugin_Report1';
    }
    ...
    {
        $view = new View('@HAPlugin/getReport1');
        $view->myData = array();
